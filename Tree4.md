...
## [3721. Longest Balanced Subarray II](https://leetcode.com/problems/longest-balanced-subarray-ii/)  2724

- [Official](https://leetcode.com/problems/longest-balanced-subarray-ii/editorial/)
- [Official](https://leetcode.cn/problems/longest-balanced-subarray-ii/solutions/3896555/zui-chang-ping-heng-zi-shu-zu-ii-by-leet-b72t/)
...
2. Build a lazy segment tree over start indices l in [0..n-1]
   that supports range add and can tell if any index has value 0 (keep mn/mx).
...
5. Slide left l: pop pos[nums[l]], let next = next occurrence or n,
   do update(0, next-1, -sign), then query for any r >= l with value 0 and update ans = max(ans, r-l+1).
```
